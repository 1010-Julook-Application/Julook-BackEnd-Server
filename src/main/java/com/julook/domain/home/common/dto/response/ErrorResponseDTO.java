...
public class ErrorResponseDTO {
     ...
     */
    @Builder
    protected ErrorResponseDTO(final ErrorCode code) {
     ...
     */
    @Builder
    protected ErrorResponseDTO(final ErrorCode code, final String reason) {
        this.resultMsg = code.getMessage();
        this.status = code.getStatus();
        this.divisionCode = code.getDivisionCode();
        this.reason = reason;
     ...
     */
    @Builder
    protected ErrorResponseDTO(final ErrorCode code, final List<FieldError> errors) {
        this.resultMsg = code.getMessage();
        this.status = code.getStatus();
        this.errors = errors;
        this.divisionCode = code.getDivisionCode();
     ...
     * @return ErrorResponse
     */
    public static ErrorResponseDTO of(final ErrorCode code, final String reason) {
        return new ErrorResponseDTO(code, reason);
    }
