...
public class SmsController {
    ...
    public SmsController() {
        this.messageService = NurigoApp.INSTANCE.initialize("NCS8TLFOTD5D3KFL", "DXFIVZ9M1B8KSXMKJBOTQ7XWCKPSZHHV", "https://api.coolsms.co.kr");
    }
    ...
    public SingleMessageSentResponse sendOne() {
        ...
        message.setFrom("01041411316");
        message.setTo("01067753153");
        message.setText("안뇽?");
